...
<body>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="<?php echo SYSTEM_URL; ?>/blog">Blog</a></li>
                            <li><a href="<?php echo SYSTEM_URL; ?>/contact">Contact</a></li>
                        </ul>
                    </nav>
                </div>
    ...
    <section class="blog-details-hero set-bg" data-setbg="<?php echo SYSTEM_URL; ?>/img/blog/details/details-hero.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                            ...
                            <div class="blog__sidebar__recent">
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="<?php echo SYSTEM_URL; ?>/img/blog/sidebar/sr-1.jpg" alt="">
                                    </div>
                                ...
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="<?php echo SYSTEM_URL; ?>/img/blog/sidebar/sr-2.jpg" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                                ...
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="<?php echo SYSTEM_URL; ?>/img/blog/sidebar/sr-3.jpg" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                ...
                <div class="col-lg-8 col-md-7 order-md-1 order-1">
                    <div class="blog__details__text">
                        <img src="<?php echo SYSTEM_URL; ?>/img/blog/details/details-pic.jpg" alt="">
                            ...
                            <div class="col-lg-6">
                                <div class="blog__details__author">
                                    <div class="blog__details__author__pic">
                                        <img src="<?php echo SYSTEM_URL; ?>/img/blog/details/details-author.jpg" alt="">
                                    </div>
